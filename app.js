var watches = {
  ...
  function searchProduct() {
    ...
    if(brandSelect === "" || productSelect === "" ){
      alert("Please select any brand or product.")
    }
    ...
    for (var keys in watches[selectedBrand]) {
      if (watches[selectedBrand][keys].name === selectedProduct) {
        productName.innerHTML= (watches[selectedBrand][keys].name);
       
        productImage.src = watches[selectedBrand][keys].img;
        productPrice.innerHTML= (watches[selectedBrand][keys].price);
        productDetail.innerHTML= (watches[selectedBrand][keys].caption);
      }
      }
    }
